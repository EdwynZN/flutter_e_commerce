...
final jwtValidatorProvider = Provider<JWTValidator>.internal(
  jwtValidator,
  name: r'jwtValidatorProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$jwtValidatorHash,
  dependencies: null,
...
final dioOptionsProvider = Provider<BaseOptions>.internal(
  dioOptions,
  name: r'dioOptionsProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$dioOptionsHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
