...
abstract class $ProductCopyWith<$Res> {
  ...
  $Res call(
      ...
      String? description,
      double price,
      @JsonKey(readValue: _mapImages) List<ProductImage> images});
}
...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, title: $title, description: $description, price: $price, images: $images)';
  }
...
abstract class _Product implements Product {
  const factory _Product(
      ...
      @JsonKey(readValue: _mapImages)
      required final List<ProductImage> images}) = _$ProductImpl;
...
class _$ProductImageImpl implements _ProductImage {
  const _$ProductImageImpl({required this.image});
...
abstract class _ProductImage implements ProductImage {
  const factory _ProductImage({required final String image}) =
      _$ProductImageImpl;
